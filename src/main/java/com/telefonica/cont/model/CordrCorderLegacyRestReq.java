...
/**
 * The persistent class for the CordrCorderLegacyRestReqS database table.
 */
@Entity
@NamedQuery(name = "CordrCorderLegacyRestReq.findAll", query = "SELECT c FROM CordrCorderLegacyRestReq c")
@Table(name = "CORDR_CORDER_LEGACY_REST_REQ")
public class CordrCorderLegacyRestReq implements Serializable {
